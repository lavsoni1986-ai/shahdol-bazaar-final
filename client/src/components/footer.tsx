...
export function Footer() {
  return (
    <footer className="glass-card-3d text-white mt-16 border-t border-white/10 pt-8 pb-6 px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 mb-6">
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-xs">
              <li><Link href="/search?q=hospital" className="hover:text-orange-500 transition-colors">Hospitals</Link></li>
              <li><Link href="/bus" className="hover:text-orange-500 transition-colors">Bus Timings</Link></li>
              <li><Link href="/marketplace-stores" className="hover:text-orange-500 transition-colors">Markets</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-xs">
              ...
              <li><a href="mailto:contact@shahdolbazaar.com" className="hover:text-orange-500 transition-colors">Email Us</a></li>
            </ul>
          </div>
        </div>
